...
import serverClient from "../../server/createServer_back";
import { QueryKeys } from "@/app/utils/query-keys";

const _getDefaultPortfolioB = async (category: string) => {
  try {
...
export const getDefaultPortfolioB = async (category: string) => {
  const _unstable_cache = unstable_cache(
    async () => await _getDefaultPortfolioB(category),
